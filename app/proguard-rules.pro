...
-keep public class com.smart.plug.domain.entity.** {
   public void set*(***);
   public *** get*();
   public *** is*();
}
-keep public class com.smart.plug.module.ui.moviedetails.event.** {
   public void set*(***);
   public *** get*();
   public *** is*();
}
...
# 将下面替换成自己的实体类
-keep class com.smart.plug.domain.entity.** { *; }
...
-keep class com.red.databindingadapterhelp.*
